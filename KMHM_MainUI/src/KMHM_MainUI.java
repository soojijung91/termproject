...
public class KMHM_MainUI extends JFrame {
    ...
    private void increase(int index) {
        ...
        String[][][] options = {
                { { "7~8시간", "6시간", "5시간", "4시간", "4시간 미만" }, { "아니오", "보통", "가끔", "자주", "매우 자주" }, { "1시간 전 끔", "30분 전", "10분 전", "잠들 때까지 사용", "계속 사용" }, { "있다(규칙적)", "가끔 있다", "거의 없다", "전혀 없다", "모름" }, { "없다", "거의 없다", "가끔", "자주", "매우 자주" } },
                { { "3번 이상", "2번", "1번", "가끔", "전혀 없음" }, { "없음", "거의 없음", "가끔 있음", "자주 있음", "매우 자주 있음" }, { "없음", "한 번", "두 번", "세 번 이상", "지금도 있음" }, { "항상 착용", "대부분 착용", "가끔 착용", "거의 안 함", "전혀 안 함" }, { "없음", "거의 없음", "가끔", "자주", "매우 자주" } },
                { { "항상", "대부분", "가끔", "거의 없음", "불규칙" }, { "없음", "주 1~2회", "주 3~4회", "주 5회 이상", "매일" }, { "없음", "거의 없음", "가끔 있음", "자주 있음", "매우 자주 있음" }, { "없음", "거의 없음", "가끔", "자주", "매우 자주" }, { "1.5L 이상", "1L 이상", "0.5~1L", "0.5L 미만", "거의 안 마심" } },
                { { "주기적으로 측정", "가끔", "1~2번", "거의 없음", "전혀 없음" }, { "주 5회 이상", "주 3~4회", "주 1~2회", "가끔", "전혀 없음" }, { "거의 안 먹음", "가끔 먹음", "보통", "자주 먹음", "매우 자주 먹음" }, { "없음", "1~2kg 증가", "1~2kg 감소", "3kg 이상 변화", "모름" }, { "없음", "잘 모름", "먼 친척", "직계 가족 중 1명", "직계 가족 2명 이상" } }
        };
        int[][][] scores = {
